  ...
  return (
    <>
      ...
      <div style={{ marginTop: 84, background: "var(--tint)", border: "1px solid var(--tint-bd)", borderRadius: 28, padding: "clamp(36px,5vw,56px) 28px", textAlign: "center" }}>
        ...
        <p style={{ fontSize: 15.5, lineHeight: 1.65, color: "var(--mut)", maxWidth: 520, margin: "12px auto 0" }}>Set up your AI receptionist in 22 minutes and see the magic of hello22 in action. 14-day free trial, no credit card needed.</p>
