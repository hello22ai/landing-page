  ...
  return (
    <PageShell current="/about" maxWidth={1200}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(min(100%,420px),1fr))", gap: 40, alignItems: "center" }}>
        ...
        {/* photo + serving chip */}
        <div style={{ position: "relative", maxWidth: 440, justifySelf: "center", width: "100%" }} aria-hidden="true">
          <div style={{ borderRadius: 26, overflow: "hidden", border: "1px solid var(--line2)", boxShadow: "0 26px 54px -32px var(--sh1)" }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img src="/images/cta-wave.jpg" alt="" style={{ width: "100%", display: "block" }} />
          </div>
          <div style={{ position: "absolute", left: -14, bottom: 20, background: "var(--surface)", border: "1px solid var(--line2)", borderRadius: 14, padding: "11px 16px", boxShadow: "0 12px 28px -16px var(--sh2)" }}>
